...
export const metadata: Metadata = {
  title: 'Knarre - Skramz-Pop aus Berlin',
  description: 'Knarre ist eine Punk Rock Band aus Berlin. Vor sechs Jahren gegründet bleibt Knarre ein Produkt aus Freundschaft und Zufall. "Hundeleben" erschien 2024 bei Through Love Records. Irgendwo zwischen Screamo, Punk und Post-Punk.',
  keywords: ['Knarre', 'Punk Rock', 'Berlin', 'Skramz-Pop', 'Through Love Records', 'Hundeleben', 'Punk Rock Berlin'],
  openGraph: {
    title: 'Knarre - Skramz-Pop aus Berlin',
    description: 'Skramz-Pop aus Berlin seit 2018. Vier Freunde machen gemeinsam Krach mit Melodie.',
      ...
      <main className="max-w-6xl mx-auto p-8 pb-16">
        <header className="text-left mb-8">
          <Image
            ...
            alt="Knarre Band Logo - Punk Rock aus Berlin"
            width={1024}
            height={459}
        ...
        <section className="mb-16" aria-labelledby="videos-heading">
          <h2 id="videos-heading" className="sr-only">Knarre Videos</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="overflow-hidden retro-grey">
              <iframe
                width="100%"
                height="315"
                src="https://www.youtube-nocookie.com/embed/B81U2EJkOvs?si=XgYU1DjLqkvENPAi"
                title="Knarre Live Performance - Hundeleben Album"
            ...
            <div className="overflow-hidden retro-grey">
              <iframe
                ...
                title="Knarre Music Video - Punk Rock Berlin"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                allowFullScreen
                className="w-full"
              ></iframe>
        ...
        <div className="mb-16 p-8 retro-grey">
          <a
